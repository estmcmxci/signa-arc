...
- The vault holds and moves Arc testnet USDC. EUR is the underlying portfolio denomination; this demo does not require EURC token transfers. Explain that distinction consistently in credentials, documentation, and the dashboard.
