...
- **Revised 2026-09-10 (E-DEC-2):** the demo *does* move real testnet EURC, as a labelled mock conversion leg. EURC is never presented as the exposure, never read by the coverage ratio, and never held by the vault. See `EED.md` §7, requirements E-EUR-1 … E-EUR-5.
