...
<!--
VENDORED — not our file. Do not edit the body; re-pull to update.

  Source:    https://github.com/circlefin/skills
  Path:      plugins/circle/skills/use-arc/SKILL.md
  Raw:       https://raw.githubusercontent.com/circlefin/skills/master/plugins/circle/skills/use-arc/SKILL.md
  Retrieved: 2026-09-09
  Publisher: Circle Internet Financial (circlefin)

  Circle's own disclaimer and Developer Terms are retained at the foot of this file.
  Our verified notes, and anything we learn that this file does not cover, live in
  ARC-FIELD-NOTES.md at the repository root.
-->
